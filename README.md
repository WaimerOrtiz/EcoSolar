...
<img src="https://github.com/WaimerOrtiz/EcoSolar/blob/main/Logo_EcoSolar_StableDiffusion.png?raw=true" alt="Imagen" widht="200" height="150">
...
- **Logo Leonardo**
<img src="https://github.com/WaimerOrtiz/EcoSolar/blob/main/Logo_EcoSolar_Leonardo.png?raw=true" alt="Imagen" widht="200" height="150">
...
**Misión:**
"Proveer soluciones de energía solar accesibles y eficientes para contribuir a un mundo más sostenible, democratizando la producción de energía limpia para familias de conciencia social y ambiental desarrollada e ingresos moderados."

**Visión:**
"Ser líderes en el mercado de energía solar en Colombia, reconocidos por nuestra innovación, calidad y compromiso con el medio ambiente y la accesibilidad."

**Valores de Marca:**
- **Innovación:** Desarrollamos tecnologías de vanguardia para maximizar la eficiencia solar.
- **Sostenibilidad:** Nos comprometemos con prácticas ecológicas en todas nuestras operaciones.
- **Calidad:** Ofrecemos productos de alta calidad que garantizan durabilidad y rendimiento.
- **Accesibilidad:** Hacemos que la energía solar sea asequible para todos.
- **Responsabilidad:** Trabajamos para mejorar la calidad de vida de nuestros clientes y comunidades.

## 3. Propuesta de Valor

**Propuesta de Valor Única:**
"Ofrecemos sistemas solares fotovoltaicos de baja potencia de buena calidad y eficiencia, diseñados específicamente para puntos de consumo independientes de la red, permitiendo a nuestros clientes generar su propia energía de manera accesible y sostenible para suplir parte de su consumo."

## 4. Evidencias del Proceso de Creación

Se anexan las evidencias del proceso:
- Los prompts para MISTRAL IA para generar: nombre de la marca, eslogan, misión, visión, valores y propuesta de valor.
- Imágenes del logotipo creadas con Stable Diffusion, Imagen3 y Leonardo.
- Eliminación de fondos de imágenes usando herramienta de eliminación de fondos Remove.bg
- Edición de imágenes de logos usando Canva

**Reflexión:**
"Usar IA generativa facilitó enormemente el proceso creativo. MISTRAL nos ayudó a generar ideas claras y coherentes para la identidad de marca, mientras que Stable_Diffusion/Imagen3/Leonardo y Canva nos permitió visualizar y diseñar un logotipo que representa perfectamente nuestra visión y valores. La experiencia fue rápida y eficiente, permitiéndonos iterar y ajustar nuestras ideas con facilidad."
...
| Num | Contenido                      | Fecha y Hora       | Red Social |
|-----|--------------------------------|--------------------|------------|
...
- **Asistente Virtual:** ¡Hola! Bienvenido a EcoSolar. ¿Cómo puedo ayudarte hoy?
- **Cliente:** Estoy interesado en adquirir un sistema solar fotovoltaico para mi hogar.
- **Asistente Virtual:** ¡Genial! Para ayudarte a seleccionar el kit adecuado, necesito saber algunos detalles. ¿Cuántos electrodomésticos planeas alimentar con el sistema solar?
- **Cliente:** Quiero alimentar una nevera pequeña, un televisor, un computador y algunos bombillos.
- **Asistente Virtual:** Perfecto. ¿Tienes alguna preferencia en cuanto a la potencia del kit? Nuestros kits van desde 0.24 kWp hasta 1.5 kWp.
- **Cliente:** No estoy seguro, ¿cuál me recomiendas?
- **Asistente Virtual:** Basado en tus necesidades, te recomiendo el Kit SFV de 0.99 kWp. Este kit es ideal para alimentar varios electrodomésticos y dispositivos electrónicos, ofreciendo un buen equilibrio entre costo y eficiencia.
- **Cliente:** Suena bien. ¿Cuál es el costo y la disponibilidad de este kit?
- **Asistente Virtual:** El Kit SFV de 0.99 kWp tiene un costo de [precio] y está actualmente disponible. ¿Te gustaría proceder con la compra o necesitas más información?
- **Cliente:** Me gustaría proceder con la compra.
- **Asistente Virtual:** ¡Excelente! Te redirigiré a nuestra página de compras para que puedas completar tu pedido. ¿Tienes alguna otra pregunta?

# Derrotero de Preguntas Potenciales para el Asistente Virtual

## 1. Características del Producto
- ¿Qué incluye el Kit SFV de 0.64 kWp?
- ¿Cuál es la vida útil de las baterías de GEL?
- ¿Los paneles solares son resistentes a condiciones climáticas extremas?
- ¿Qué tipo de garantía ofrecen los productos de EcoSolar?
- ¿Los kits incluyen la instalación?

## 2. Disponibilidad
- ¿El Kit SFV de 1.32 kWp está disponible actualmente?
- ¿Cuál es el tiempo de entrega para los kits SFV?
- ¿Puedo reservar un kit SFV y recogerlo en una tienda física?
- ¿Ofrecen envío gratuito para los kits SFV?
- ¿Puedo comprar un kit SFV y recogerlo el mismo día?

## 3. Comparaciones con Otros Productos
- ¿Cuál es la diferencia entre el Kit SFV de 0.64 kWp y el de 0.99 kWp?
- ¿Qué kit SFV es más adecuado para una casa pequeña?
- ¿Los kits SFV de EcoSolar son más eficientes que los de otras marcas?
- ¿Qué kit SFV es mejor para alimentar varios electrodomésticos?
- ¿Cuál es el kit SFV más económico?

## 4. Uso y Mantenimiento
- ¿Cómo se instala un kit SFV de EcoSolar?
- ¿Qué mantenimiento requieren los kits SFV?
- ¿Los kits SFV necesitan conexión a la red eléctrica?
- ¿Puedo expandir mi kit SFV en el futuro?
- ¿Qué hago si mi kit SFV no genera suficiente energía?

# Sistema de Filtrado de Opciones para el Asistente Virtual

## Paso 1: Bienvenida y Presentación
- Saludo inicial y presentación del asistente virtual.
- Pregunta sobre el propósito de la visita del cliente.

## Paso 2: Identificación de Necesidades
- Preguntas sobre el número y tipo de electrodomésticos a alimentar.
- Preguntas sobre el presupuesto del cliente.
- Preguntas sobre preferencias de potencia y características específicas.

## Paso 3: Recomendación de Productos
- Basado en las respuestas del cliente, el asistente virtual recomienda el kit SFV adecuado.
- Explicación de las características y beneficios del producto recomendado.

## Paso 4: Información Adicional
- Respuesta a preguntas sobre disponibilidad, costo y comparaciones con otros productos.
- Información sobre garantía, instalación y mantenimiento.

## Paso 5: Proceso de Compra
- Redirección a la página de compras para completar el pedido.
- Oferta de asistencia adicional si el cliente tiene más preguntas.

## Paso 6: Seguimiento Post-Venta
- Envío de un correo electrónico de confirmación con detalles del pedido.
- Información sobre cómo contactar al servicio de atención al cliente para cualquier consulta adicional.

# Experiencia de Usuario Amigable

## Interfaz Intuitiva
- Diseño limpio y fácil de navegar.
- Botones claros y visibles para cada opción de respuesta.

## Lenguaje Sencillo
- Uso de un lenguaje claro y accesible.
- Evitar tecnicismos y explicar conceptos complejos de manera sencilla.

## Interacción Natural
- Respuestas rápidas y precisas.
- Capacidad de entender y responder a preguntas formuladas de diferentes maneras.

## Personalización
- Uso del nombre del cliente (si proporcionado) para crear una experiencia más personal.
- Recomendaciones basadas en las respuestas específicas del cliente.

## Asistencia Continua
- Disponibilidad 24/7 para responder preguntas y ofrecer asistencia.
- Opciones de contacto adicionales (chat en vivo, correo electrónico, teléfono) para consultas más complejas.

# Optimización de la Experiencia de Usuario

## Encuesta de Retroalimentación para Clientes de EcoSolar

Dado que no puedo acceder a herramientas externas como SurveyMonkey o Typeform, te proporcionaré una encuesta detallada que puedes implementar en cualquier plataforma de encuestas de tu preferencia.
...
3. **¿Cuál es tu nivel de ingresos mensuales?**
...
### Sección 2: Conocimiento de la Marca

4. **¿Cómo te enteraste de EcoSolar?**
   - Redes sociales (por favor especificar cuál)
   - Búsqueda en Google
...
5. **¿Qué te motivó a visitar nuestra página web?**
   - Interés en adquirir un sistema solar fotovoltaico
   - Curiosidad sobre la energía solar
   - Comparar productos con otras marcas
   - Recomendación de un conocido
   - Otro (por favor especificar)

### Sección 3: Experiencia con el Producto

6. **¿Has adquirido algún producto de EcoSolar?**
   - Sí
   - No

7. **Si respondiste "Sí" a la pregunta anterior, ¿qué producto adquiriste?**
   - Kit SFV de 0.24 kWp
   - Kit SFV de 0.33 kWp
   - Kit SFV de 0.64 kWp
   - Kit SFV de 0.88 kWp
